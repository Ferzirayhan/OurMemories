    ...
    <div className="min-h-screen tracking-wide font-sans relative overflow-hidden" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
      ...
      >
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          className="mt-16 sm:mt-32 pt-16 sm:pt-32 text-center"
          style={{ borderTop: '1px solid var(--border)' }}
        >
            <div className="glass p-8 sm:p-12 md:p-20 rounded-[2rem] sm:rounded-[3rem] relative overflow-hidden group">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif italic mb-4 sm:mb-6 font-light" style={{ color: 'var(--text-primary)' }}>The Secret Space</h2>
